...
var _MoibleMenu = __webpack_require__(3);

var _MoibleMenu2 = _interopRequireDefault(_MoibleMenu);
...
var mobileMenu = new _MoibleMenu2.default(); // related to this cuz nothing in the compiled javascript will be like this

var revealFeatureOnScroll = new _RevealOnScroll2.default(".testimonial", "60%");
var revealFeatureOnScroll = new _RevealOnScroll2.default(".feature-item", "85%");
...
var MobileMenu = function () {
    function MobileMenu() {
        ...
        this.menuIcon = (0, _jquery2.default)(".site-header--menu-icon");
        this.menuContent = (0, _jquery2.default)(".site-header--menu-content");
        this.events();
    }
...
var RevealOnScroll = function () {
    function RevealOnScroll(className, offSet) {
        _classCallCheck(this, RevealOnScroll);

        this.itemsToReveal = (0, _jquery2.default)(className); /**collections of elements */
        this.offSet = offSet;
        this.hideInitially();
            ...
            this.itemsToReveal.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler() {
                        (0, _jquery2.default)(current).addClass("reveal-item--is-visible"); //this will add for evey single item
...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.siteHeader = (0, _jquery2.default)(".site-header"); //this is a jquery object, [0]For getting the dom object
...
var Modal = function () {
    function Modal() {
        ...
        this.openModelButton = (0, _jquery2.default)(".open-modal");
        this.modal = (0, _jquery2.default)(".modal");
        this.closeModelButton = (0, _jquery2.default)(".modal--close");
        this.events();
    }
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            (0, _jquery2.default)(document).keyup(this.keyPrssHandler.bind(this));
        }
    }, {
        key: "keyPrssHandler",
        value: function keyPrssHandler(e) {
            if (e.keyCode == 27) {
                this.closeModel();
            }
        }
